...
mode = int(input("EVALUATE AND MATRICS (0 = classifier and 1 = autoencoder)?: "))
...
if mode == 0:
    ...
    data_dir = r"C:\Users\larar\OneDrive\Documentos\Escritorio\Histopathological_Diagnosis-5\USABLE_annotated"
