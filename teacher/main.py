...
def get_train_dataset(IMAGE_SIZE=256):
    train_dataset = TripletDataset(train_set, path=train_data_path, train=True, transform=transforms.Compose([transforms.ToTensor(), transforms.Resize((IMAGE_SIZE, IMAGE_SIZE))]))
