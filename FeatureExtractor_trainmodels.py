...
log_file = open(r'/export/fhome/vlia04/MyVirtualEnv/Histopathological_Diagnosis/best_models_training.txt', 'w')  
...
def plot_loss_curve(epoch_losses, epoch_accuracies,epoch_recalls, model_filename):
    os.makedirs(r"/export/fhome/vlia04/MyVirtualEnv/Histopathological_Diagnosis/train_plots", exist_ok=True)
    ...
    save_path_combined = os.path.join(r"/export/fhome/vlia04/MyVirtualEnv/Histopathological_Diagnosis/train_plots", f"{model_filename}_metrics.png")
...
if model_decision == 0:
    ...
    annotated_csv = pd.read_csv(r"/export/fhome/vlia04/MyVirtualEnv/Histopathological_Diagnosis/all_annotations_with_patient_diagnosis.csv")

    # Load all images from `USABLE_annotated` using all_annotations
    data_dir = r"/export/fhome/vlia04/MyVirtualEnv/Histopathological_Diagnosis/USABLE_annotated"
    ...
    save_folder = r"/export/fhome/vlia04/MyVirtualEnv/Histopathological_Diagnosis/best_saved_models"
    os.makedirs(save_folder, exist_ok=True)

    # Set up folder to save validations
    save_folder1 = r"/export/fhome/vlia04/MyVirtualEnv/Histopathological_Diagnosis/validation_and_training_data"
